...
const PRODUCTS: Product[] = [
  ...
  { id: 3, name: 'Organic Honey', price: 12.50, category: 'Groceries', rating: 4.9, image: 'https://images.unsplash.com/photo-1587049352847-4d4b121bc32b?w=500&q=80' },
  { id: 4, name: 'Smart Fitness Band', price: 45.00, category: 'Electronics', rating: 4.3, image: 'https://images.unsplash.com/photo-1575311373937-040b8e1fd5b0?w=500&q=80' },
];
